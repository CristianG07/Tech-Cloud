...
export const Catalog = ({ toggle }) => {
  return (
    <section
      className={`${
        toggle ? 'block' : 'hidden'
      } absolute top-full lg:left-0 lg:right-0 w-[90%] mx-auto max-w-xl lg:max-w-[90%] bg-card_gray shadow-lg rounded-b-xl lg:rounded-xl py-7 lg:py-16 transition-opacity duration-700`}
    >
